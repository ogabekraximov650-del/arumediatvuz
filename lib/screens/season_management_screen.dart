...
class _SeasonManagementScreenState extends State<SeasonManagementScreen> {
  ...
  Future<void> _deleteSeason(int id, String nomi) async {
    ...
    try {
      final res = await http.delete(Uri.parse('$API_BASE/api/seasons/$id'));
      if (res.statusCode == 200) {
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            decoration: BoxDecoration(
                                              borderRadius: BorderRadius.circular(12),
                                              image: DecorationImage(
                                                image: NetworkImage(s['photo_url'] ?? ''),
                                                fit: BoxFit.cover,
                                                onError: (_, __) {},
                                              ),
                                              color: Colors.white.withOpacity(0.10),
