...
class _HomeScreenState extends State<HomeScreen> {
  // Endi bosh sahifa season_db'dan (Bo'limlar) ma'lumot ko'rsatadi —
  // Animelarni boshqarish (anime_db) faqat admin uchun, bu yerda ko'rinmaydi.
  ...
  Future<void> _fetchFromApi({bool force = false, bool showLoading = false}) async {
                  ...
                  if (_isOffline)
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Icon(Icons.wifi_off_rounded, size: 14, color: Colors.orange.shade300),
              ...
              child: SizedBox(
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      Icon(
                        _isOffline ? Icons.wifi_off_rounded : Icons.movie_creation_outlined,
                        size: 52,
                        color: Colors.white.withOpacity(0.2),
                      ),
                      const SizedBox(height: 12),
                      Text(
                        _isOffline ? 'Internet yo\'q — yuqoriga torting' : 'Anime topilmadi',
            ...
            SliverPadding(
              ...
              sliver: SliverGrid(
                ...
                delegate: SliverChildBuilderDelegate(
                  (context, index) => RepaintBoundary(child: SeasonCard(season: _seasons[index])),
            ...
            transitionsBuilder: (_, animation, __, child) {
              ...
              return FadeTransition(
                ...
                child: ScaleTransition(
                    scale: Tween(begin: 0.97, end: 1.0).animate(curved), child: child),
              );
            },
          ),
        );
                    ...
                    if (photoUrl != null && photoUrl.isNotEmpty)
                      CachedNetworkImage(
                        ...
                        placeholder: (_, __) => Container(
                          ...
                          child: Center(
                            child: CircularProgressIndicator(
                                strokeWidth: 2, valueColor: AlwaysStoppedAnimation(AppColors.accent)),
                          ),
                        ),
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        season['janri'] ?? '',
                        style:
                            TextStyle(fontSize: 10, color: AppColors.accent, fontWeight: FontWeight.w600),
                      ),
                    ),
                  ],
                ),
